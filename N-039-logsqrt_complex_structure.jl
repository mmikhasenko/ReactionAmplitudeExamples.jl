...
# ╔═╡ fb6e8268-8ac2-49b7-8da6-d0585f459b24
using PlutoUI
...
@bind ϕ0 Slider((-3.5:0.1:3.5) .* π, default=-π/2, show_value=true)

# ╔═╡ 15391a8f-31f4-4daa-b614-b2fae81320a3
heatmap(range(-3,3,200), range(-3,3,200), (x,y)->imag(f_I(x+1im*y, ϕ0, ϕ_log)))

# ╔═╡ 98803e37-dcb7-4ad3-b2eb-98766a09faf9
heatmap(range(-3,3,200), range(-3,3,200), (x,y)->imag(f_II(x+1im*y, ϕ0, ϕ_log)))
