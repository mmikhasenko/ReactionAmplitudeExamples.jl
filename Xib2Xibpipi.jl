...
# ╔═╡ ec0cea04-79ee-4841-8caf-f22d4b409daa
...
dl(j0,l,λ,ν; ξ::Chain) =
	...
	clg(l,0,ξ.j,ν,j0,ν) * WignerD(ξ.j,ν,λ,0,θ,0).doit() * clg(ξ.l,0,1/Sym(2),λ,ξ.j,λ)

# ╔═╡ 550a063a-34e8-4ab8-9659-9ac126a08b5d
function I(j0,l; ξ::Chain)
	sum(abs2(dl(j0,l,two_ν/Sym(2),two_λ/Sym(2); ξ))
...
julia_version = "1.8.1"
manifest_format = "2.0"
project_hash = "c9f8f8331fafda998de204e5793390fac72c8f08"
