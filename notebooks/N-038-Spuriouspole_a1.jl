...
md"""
### Parameters:
mR = $(@bind mR Slider(range(0.5, 1.5, length=25); show_value=true, default=1.0))

g = $(@bind g Slider(range(1.0, 6.0, length=11); show_value=true, default=5.0))
"""
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "df9f909ddff042a14a2867eb478e48efcadf29cb"
