...
md"""
#### Phase space suppression of $\Xi_c^{\prime+}K^-$ is $(round(ℝ))
"""

# ╔═╡ 703be9e2-c8f2-4144-b977-93d64d1e901b
md"""
$\begin{align}
\mathbb{B} &= \frac
{\mathrm{Br}(\Omega_c^0(3065)\to\Xi_c^+ K^-)}
{\mathrm{Br}(\Omega_c^0(3065)\to\Xi_c^{\prime+} K^-)}\\
&=
\frac
{g_{\Xi_c^+ K^-}^2\int |\text{BW}|^2\rho(\Xi_c^+ K^-) \mathrm{d} s}
{g_{\Xi_c^{\prime+} K^-}^2\int |\text{BW}|^2\rho(\Xi_c^{\prime+} K^-) \mathrm{d} s}\\
&=
\frac
{g_{\Xi_c^+ K^-}^2}
{g_{\Xi_c^{\prime+} K^-}^2}
...
md"""
#### Assumed $\mathrm{Br}(\Xi_c^+ K^-)$/$\mathrm{Br}(\Xi_c^{\prime+} K^-)$ is $(𝔹_exp)
"""
...
md"""
#### The ratio ${g_{\Xi_c^+ K^-}} / g_{\Xi_c^{\prime+} K^-}$ is $(round(g_ΞcK_over_Ξc′K, digits=2))
"""
...
md"""
### Reproducing thr nominal model with r = 0
"""
...
md"""
### Turning on the coupled channel
"""
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "5b655bda42f65c6d0c6a2d0214b27453fcfb6207"
