...
md"""
# Benchmark of fitting frameworks

This notebook builds a model of gaussian signal and exponential background and perform pseudoexperiments of generation and fitting.
"""
...
# ╔═╡ 64aa4c5c-e288-4c09-a7f1-8271103b70f0
...
# ╔═╡ 5476d43c-4ac4-4918-925a-8192eb870e41
@btime a_toy_optim(1000)

# ╔═╡ d58b1a84-e947-4365-8349-7c4a90c8069c
@btime a_toy_optim(10_000)

# ╔═╡ 0b53ad35-2a1f-4db2-bf5f-1ef0593d7681
@btime a_toy_optim(100_000)

# ╔═╡ 875f4285-8664-473c-a59e-2bca88fa6e29
md"""
## Minuit
"""

# ╔═╡ 5940af2a-e872-4a65-8f20-32293ac9587a
@btime a_toy_minuit(1_000).fit_res

# ╔═╡ 50385c1a-8ca9-4ec9-a320-24d4fe42f8de
@btime a_toy_minuit(10_000).fit_res

# ╔═╡ 18cb6356-f7e0-4348-a69d-1097d97038e1
@btime a_toy_minuit(100_000).fit_res
...
manifest_format = "2.0"
project_hash = "8b2d160e9c205c7040729f8f3267c3f513229397"
...
[[deps.Minuit2]]
deps = ["CxxWrap", "Distributions", "Libdl", "LinearAlgebra", "Minuit2_Julia_Wrapper_jll", "PrettyTables"]
git-tree-sha1 = "786aeafd13acebbfe1eb5f0b480c3d291b6ef06c"
uuid = "37821647-3276-4ed8-9a4e-bc9886b3c106"
version = "0.2.1"
weakdeps = ["FHist", "FiniteDiff", "Plots"]

    [deps.Minuit2.extensions]
    Minuit2FHistExt = ["FHist"]
    Minuit2PlotsExt = ["Plots", "FHist"]

[[deps.Minuit2_Julia_Wrapper_jll]]
deps = ["Artifacts", "JLLWrappers", "Libdl", "Minuit2_jll", "libcxxwrap_julia_jll"]
git-tree-sha1 = "a761df95592d5db78d4f93e775ffd444dc7bc345"
uuid = "65cff058-67fb-5034-9600-a8f6a0feb90b"
version = "0.3.1+0"

[[deps.Minuit2_jll]]
deps = ["Artifacts", "JLLWrappers", "Libdl"]
git-tree-sha1 = "bee644bdca89d8ccb98758ed62ed8f1771a5d077"
uuid = "683d4edd-6ccf-5a74-985b-ebee5a2d6cb7"
version = "6.34.2+0"
