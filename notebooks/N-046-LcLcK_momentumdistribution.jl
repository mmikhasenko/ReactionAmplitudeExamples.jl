...
Checks impect of a low efficiency to the marginalized mass dimension. Related to [LHCb paper](https://inspirehep.net/literature/2175466).
"""
...
phsp = let
	_data = y2σs.(eachslice(rand(100_000,2); dims=1), Ref(ms))
	# latDalitzPlotSample(ms; Nev = 1_000_000);
	filter!(σs->(isphysical(σs, ms)), _data)
end
...
manifest_format = "2.0"
project_hash = "9daf69c5be2ae9a8d22884485907fbe71f9d6417"
